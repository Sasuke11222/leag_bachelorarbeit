...
public class KraftwerkController {
    ...
    public ResponseEntity<Kraftwerk> createKraftwerk(@RequestBody Kraftwerk kraftwerk) {
        ...
        if(existingKraftwerk.isPresent()) {
            ...
            _kraftwerk.setKw_id(kraftwerk.getKw_id());
     ...
     public ResponseEntity updateKraftwerk(@PathVariable("kw_id") Long kw_id, @RequestBody Kraftwerk updatedKraftwerk) {
        Optional kraftwerkOptional = kraftwerkRepository.findById(kw_id);
        if (kraftwerkOptional.isPresent()) {
            Kraftwerk kraftwerk = (Kraftwerk) kraftwerkOptional.get();
